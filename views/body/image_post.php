...
<div style="margin: 20px 0">
    ...
    <div class="row">
        ...
        <img postbool="<?php echo $post_bool; ?>" post="<?php echo $post_id; ?>" class="img-responsive click-img <?php echo $offset?>" style="border-top:1px solid #e3e3e3;display:block;margin:0 auto;" src="data:<?php echo $mimeType;?>;base64,<?php echo base64_encode($blob);?>">
