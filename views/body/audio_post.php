...
<div style="margin: 20px 0">
    ...
    <div class="row">
        ...
        <img postbool="<?php echo $post_bool; ?>" post="<?php echo $post_id; ?>" class="img-responsive click-img <?php echo $offset?>" style="border-top:1px solid #e3e3e3;display:block;margin:0 auto;" src="model/files/img/downloaded (1).jpg">
        <div style="position:relative" height="0" width="0">
        ...
        <audio class="<?php echo $offset?>" loop controls style="opacity:0">
            <source type="<?php echo $mimeType;?>" src="data:<?php echo $mimeType;?>;base64,<?php echo base64_encode($blob);?>">
        </audio>
